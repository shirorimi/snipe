   ...
   //
    ...
    Scene_Item.prototype.createBackground = function(){
        if(bgBitmapItem){
            ...
            this.addChild(this._backgroundSprite_01);
            this._backgroundSprite_02 = new Sprite();
            this._backgroundSprite_02.bitmap = ImageManager.loadPicture(bgBitmapItem);
            this.addChild(this._backgroundSprite_02);
            return;
        }
        // if background file is invalid, it does original process.
    ...
    Scene_Skill.prototype.createBackground = function(){
        if(bgBitmapSkill){
            ...
            this.addChild(this._backgroundSprite_01);
            this._backgroundSprite_02 = new Sprite();
            this._backgroundSprite_02.bitmap = ImageManager.loadPicture(bgBitmapSkill);
            this.addChild(this._backgroundSprite_02);
            return;
        }
        // if background file is invalid, it does original process.
    ...
    Scene_Equip.prototype.createBackground = function(){
        if(bgBitmapEquip){
            ...
            this.addChild(this._backgroundSprite_01);
            this._backgroundSprite_02 = new Sprite();
            this._backgroundSprite_02.bitmap = ImageManager.loadPicture(bgBitmapEquip);
            this.addChild(this._backgroundSprite_02);
            return;
        }
        // if background file is invalid, it does original process.
    ...
    Scene_Status.prototype.createBackground = function(){
        if(bgBitmapStatus){
            ...
            this.addChild(this._backgroundSprite_01);
            this._backgroundSprite_02 = new Sprite();
            this._backgroundSprite_02.bitmap = ImageManager.loadPicture(bgBitmapStatus);
            this.addChild(this._backgroundSprite_02);
            return;
        }
        // if background file is invalid, it does original process.
    ...
    Scene_Options.prototype.createBackground = function(){
        if(bgBitmapOptions){
            ...
            this.addChild(this._backgroundSprite_01);
            this._backgroundSprite_02 = new Sprite();
            this._backgroundSprite_02.bitmap = ImageManager.loadPicture(bgBitmapOptions);
            this.addChild(this._backgroundSprite_02);
            return;
        }
        // if background file is invalid, it does original process.
    ...
    Scene_File.prototype.createBackground = function(){
        if(bgBitmapFile){
            ...
            this.addChild(this._backgroundSprite_01);
            this._backgroundSprite_02 = new Sprite();
            this._backgroundSprite_02.bitmap = ImageManager.loadPicture(bgBitmapFile);
            this.addChild(this._backgroundSprite_02);
            return;
        }
        // if background file is invalid, it does original process.
    ...
    Scene_GameEnd.prototype.createBackground = function(){
        if(bgBitmapGameEnd){
            ...
            this.addChild(this._backgroundSprite_01);
            this._backgroundSprite_02 = new Sprite();
            this._backgroundSprite_02.bitmap = ImageManager.loadPicture(bgBitmapGameEnd);
            this.addChild(this._backgroundSprite_02);
            return;
        }
        // if background file is invalid, it does original process.
